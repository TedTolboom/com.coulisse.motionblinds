...
In order for Homey to be allowed to send commands to the gateways, it needs a Secret Key. The key can be configured in the app settings. You will find instructions there on how to obtain the key.
